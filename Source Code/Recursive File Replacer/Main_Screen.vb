...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents filetoreplacewithtxt As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.filetoreplacewithtxt = New System.Windows.Forms.TextBox
        ...
        Me.Panel1.Controls.Add(Me.filetoreplacewithtxt)
        ...
        '
        'filetoreplacewithtxt
        '
        Me.filetoreplacewithtxt.BackColor = System.Drawing.Color.Cornsilk
        Me.filetoreplacewithtxt.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.filetoreplacewithtxt.ForeColor = System.Drawing.Color.Black
        Me.filetoreplacewithtxt.Location = New System.Drawing.Point(16, 48)
        Me.filetoreplacewithtxt.Name = "filetoreplacewithtxt"
        Me.filetoreplacewithtxt.ReadOnly = True
        Me.filetoreplacewithtxt.Size = New System.Drawing.Size(192, 20)
        Me.filetoreplacewithtxt.TabIndex = 57
        Me.filetoreplacewithtxt.Text = ""
        '
        'Label14
        '
        ...
        Me.Label14.Text = "FILE TO REPLACE WITH"
        ...
        '
        Me.filenametosearchfortxt.BackColor = System.Drawing.Color.Cornsilk
        ...
        Me.filenametosearchfortxt.Location = New System.Drawing.Point(16, 80)
        ...
        'filefoldertxt
        '
        Me.filefoldertxt.BackColor = System.Drawing.Color.Cornsilk
        ...
        Me.Label9.Text = "BUILD 20060217.2"
        ...
        Me.Label4.Text = "Recursive File Replacer does a recursive scan of the selected folder, replacing a" & _
        "ny file where the filename matches the case insensitive search term with the use" & _
        "r-specified replacement file. A check is made to ensure that the file to replace" & _
        " with never tries to overwrite itself."
        '
        'OpenFileDialog1
        '
        Me.OpenFileDialog1.Title = "Select the file to use:"
        '
        'Main_Screen
        '
        ...
        Me.Text = "Recursive File Replacer"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in Recursive File Replacer's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Recursive File Replacer") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Recursive File Replacer")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Recursive File Replacer", True)
    ...
    Private Sub force_check()
        Try
            ...
            If currently_working = False Then
                If (Not filefoldertxt.Text = "") And (Not filetoreplacewithtxt.Text = "") And (Not filenametosearchfortxt.Text = "") Then
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            If Not result = DialogResult.Cancel Then
                filetoreplacewith = OpenFileDialog1.FileName
                filetoreplacewithtxt.Text = OpenFileDialog1.FileName
            End If
